...
"total_tfu" => number_format(($max_total_fuel_used-$min_total_fuel_used)/4,2),
...
FROM 
  ...
  datos.id_componente
WHERE 
tm_data_canbus_hoy.odometer=$motor AND
tm_mobil.computadora =1 AND
  tm_mobil.id_mobil = tm_data_canbus_hoy.id_mobil AND
tm_mobil.id_mobil = tm_usuario_mobil.id_mobil AND
tm_usuario_mobil.id_usuario = $idu AND
...
tm_usuario_mobil.id_usuario =  $idu  AND
  ...
  tm_equipo.id_equipo = tm_mobil_equipo.id_equipo::int AND
  tm_equipo.id_equipo = tm_equipo_componente.id_equipo AND
  tm_equipo_componente.id_com = id_componente.id_com  and tm_mobil.id_mobil in ($serviciosList) and estado=1 and a.gps_date >to_timestamp('$fechai','DD/MM/YYYY HH24:MI') and  a.gps_date <to_timestamp('$fechaf','DD/MM/YYYY HH24:MI')  order by nombremobil, gps_date desc    ";
