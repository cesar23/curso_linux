...
#
# :::::::::::::::::::::::::::::::::::::::
#  ver ccolores en repo linux _full=> Colores/1_generar_colores.sh
# :::::::::::::::::::::::::::::::::::::::
#  \e[0m _full=_full= \033[0m
# Reset
...
BRed_full='\e[1;31m'         # Red
BGreen_full='\e[1;32m'       # Green
BYellow_full='\e[1;33m'      # Yellow
BBlue_full='\e[1;34m'        # Blue
BPurple_full='\e[1;35m'      # Purple
BCyan_full='\e[1;36m'        # Cyan
BWhite_full='\e[1;37m'       # White

# Underline
UBlack_full='\e[4;30m'       # Black
URed_full='\e[4;31m'         # Red
UGreen_full='\e[4;32m'       # Green
UYellow_full='\e[4;33m'      # Yellow
UBlue_full='\e[4;34m'        # Blue
UPurple_full='\e[4;35m'      # Purple
UCyan_full='\e[4;36m'        # Cyan
UWhite_full='\e[4;37m'       # White

# Background
On_Black_full='\e[40m'       # Black
On_Red_full='\e[41m'         # Red
On_Green_full='\e[42m'       # Green
On_Yellow_full='\e[43m'      # Yellow
On_Blue_full='\e[44m'        # Blue
On_Purple_full='\e[45m'      # Purple
On_Cyan_full='\e[46m'        # Cyan
On_White_full='\e[47m'       # White

# High Intensity
IBlack_full='\e[0;90m'       # Black
IRed_full='\e[0;91m'         # Red
IGreen_full='\e[0;92m'       # Green
IYellow_full='\e[0;93m'      # Yellow
IBlue_full='\e[0;94m'        # Blue
IPurple_full='\e[0;95m'      # Purple
ICyan_full='\e[0;96m'        # Cyan
IWhite_full='\e[0;97m'       # White

# Bold High Intensity
BIBlack_full='\e[1;90m'      # Black
BIRed_full='\e[1;91m'        # Red
BIGreen_full='\e[1;92m'      # Green
BIYellow_full='\e[1;93m'     # Yellow
BIBlue_full='\e[1;94m'       # Blue
BIPurple_full='\e[1;95m'     # Purple
BICyan_full='\e[1;96m'       # Cyan
BIWhite_full='\e[1;97m'      # White

# High Intensity backgrounds
On_IBlack_full='\e[0;100m'   # Black
On_IRed_full='\e[0;101m'     # Red
On_IGreen_full='\e[0;102m'   # Green
On_IYellow_full='\e[0;103m'  # Yellow
On_IBlue_full='\e[0;104m'    # Blue
On_IPurple_full='\e[0;105m'  # Purple
On_ICyan_full='\e[0;106m'    # Cyan
On_IWhite_full='\e[0;107m'   # White


# -------------- colores continuos
Black_persint_full=`echo -en'\e[0;30m'        # Black
Red_persint_full=`echo -en'\e[0;31m'          # Red
Green_persint_full=`echo -en'\e[0;32m'        # Green
Yellow_persint_full=`echo -en'\e[0;33m'       # Yellow
Blue_persint_full=`echo -en'\e[0;34m'         # Blue
Purple_persint_full=`echo -en'\e[0;35m'       # Purple
Cyan_persint_full=`echo -en'\e[0;36m'         # Cyan
White_persint_full=`echo -en'\e[0;37m'        # White



 bold_full=`echo -en "\e[1m"`
 underline_full=`echo -en "\e[4m"`
 normal_full=`echo -en "\e[0m"`
 black_full=`echo -en "\e[30m"`
 red_full=`echo -en "\e[31m"`
 green_full=`echo -en "\e[32m"`
 orange_full=`echo -en "\e[33m"`
 blue_full=`echo -en "\e[34m"`
 purple_full=`echo -en "\e[35m"`
 aqua_full=`echo -en "\e[36m"`
 gray_full=`echo -en "\e[37m"`
 darkgray_full=`echo -en "\e[90m"`
 lightred_full=`echo -en "\e[91m"`
 lightgreen_full=`echo -en "\e[92m"`
 lightyellow_full=`echo -en "\e[93m"`
 lightblue_full=`echo -en "\e[94m"`
 lightpurple_full=`echo -en "\e[95m"`
 lightaqua_full=`echo -en "\e[96m"`
 white_full=`echo -en "\e[97m"`
 default_full=`echo -en "\e[39m"`
 BLACK_full=`echo -en "\e[40m"`
 RED_full=`echo -en "\e[41m"`
 GREEN_full=`echo -en "\e[42m"`
 ORANGE_full=`echo -en "\e[43m"`
 BLUE_full=`echo -en "\e[44m"`
 PURPLE_full=`echo -en "\e[45m"`
 AQUA_full=`echo -en "\e[46m"`
 GRAY_full=`echo -en "\e[47m"`
 DARKGRAY_full=`echo -en "\e[100m"`
 LIGHTRED_full=`echo -en "\e[101m"`
 LIGHTGREEN_full=`echo -en "\e[102m"`
 LIGHTYELLOW_full=`echo -en "\e[103m"`
 LIGHTBLUE_full=`echo -en "\e[104m"`
 LIGHTPURPLE_full=`echo -en "\e[105m"`
 LIGHTAQUA_full=`echo -en "\e[106m"`
 WHITE_full=`echo -en "\e[107m"`
 DEFAULT_full=`echo -en "\e[49m"`
# ----------------------------------
 echo "${bold} bold "
 echo $DEFAULT
 ...
 echo "${dim} dim "
 echo $DEFAULT
 echo "${strickthrough} strickthrough "
 echo $DEFAULT
 echo "${blink} blink "
 echo $DEFAULT
 ...
 echo $DEFAULT
 echo "${lightred} lightred "
 echo $DEFAULT
 echo "${lightgreen} lightgreen "
 echo $DEFAULT
 echo "${lightyellow} lightyellow "
 echo $DEFAULT
 echo "${lightblue} lightblue "
 echo $DEFAULT
 echo "${lightpurple} lightpurple "
 echo $DEFAULT
 echo "${lightaqua} lightaqua "
 echo $DEFAULT
 echo "${white} white "
 echo $DEFAULT
