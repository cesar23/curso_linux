...
function add_custom_body_open_code() {
    ...
    <a href="https://m.me/ferrechincha" id="botn_facebook" class="float2" target="_blank">
    ...
    <div style="display: none" class="contenedor_wapsa apertura_what">
        ...
        <div class="contenedor_inferior" style="">
            ...
            <div style="width: 100%;height: 50px;margin-bottom: 3px;">
                <a target="_blank"
                   href="https://api.whatsapp.com/send?phone=51954549887&text=Hola PeruStore, tengo una consulta">
                    <i class="btn-icon fa-brands fa-whatsapp" style="float: left; margin-right: 5px;"> </i>
                    <div style="float: left">
                        <strong>Central</strong><br>954549887
                    </div>
                </a>
            </div>
...
function cmk_additional_button() {
    ...
    //echo '<a class="button success"> <span>Success Color</span> </a>';
    //echo '<a class="button success is-shade box-shadow-2 box-shadow-5-hover" style="border-radius:7px;"> <span>Shade</span> </a>';
    echo '<a class="button success is-bevel box-shadow-2 box-shadow-5-hover" style="border-radius:7px;" href="https://api.whatsapp.com/send?phone=51970789567&text=Deseo%20mas%20informaci%C3%B3n%20de%20este%20producto%3A%20'.$permalink.'"> <i class="fa-brands fa-whatsapp fa-xl"></i> <span>Cotizar este Producto</span> </a>';
...
$config_child_cesar = [
    ...
    'load_script_front_end' =>  [
        ...
        'js_add' => array(
            "script-frontend-sol"=>"soluciones-tools/js/front_end_all.js",
        ),
        'css_add' => array(
            "css-style-front-sol"=>"soluciones-tools/css/front_end_all.css",
...
// -------------- Agrega desde el admin el filtrado de las listar productos por destacados
