// return el path=> /wp-admin/admin.php?page=learndash_lms_overview
...
jQuery(document).ready(function () {
    ...
    function init() {
        ...
        //------------------------------------------------------------
        // -------------- paso 1  ocultamos menus del admin
        //------------------------------------------------------------
        let li_activos_menu = ["menu-media", "menu-posts-product", "menu-dashboard", "menu-posts-blocks", "menu-pages", "menu-posts-popup", "toplevel_page_learndash-lms", "menu-users", "toplevel_page_woocommerce"];
        let li_activos_nav = [
        ...
        let panel_activos_1 = ["custom_dashboard_widget", "dashboard_widget"];
        let panel_activos_2 = [];
