...
function my_login_stylesheet()
{
    ...
    wp_enqueue_script('script-frontend', home_url('/') . 'soluciones-tools/js/style-login.js', array('jquery'), version_id(), true);
    wp_enqueue_style('theme-override',  home_url('/') . 'soluciones-tools/css/style-login.css', array(), version_id(), 'all');
...
function add_custom_body_open_code() {
    ...
    <div class="appWhatssap">
        <a  href="https://wa.me/51933306046?text=Me%20interesa%20un%20producto%20de%20la%20<?php echo $url_amigable;?>" target="_blank">
