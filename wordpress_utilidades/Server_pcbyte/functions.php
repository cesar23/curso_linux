...
$config_child_cesar = [
    ...
    'usuarios_opciones_limitadas' => [7,8,9],
    //Aque usuarios le quitaremos los menus
    'usuarios_opciones_limitadas_menu' => [7,8,9],
    //Aque usuarios le agregaremos menus  adicionales
    'usuarios_opciones_menu_adicionales' => [7,8,9],
