...
alias ksysgpowoyaml='kubectl --namespace=kube-system get pods --watch -o=yaml'alias kgposlowide='kubectl get pods --show-labels -o=wide'
...
alias krun='kubectl run --rm --restarNever --image-pull-policy=IfNotPresent -i -t'
